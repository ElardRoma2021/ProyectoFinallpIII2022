        ...
        <li class="dropdown">
            ...
            <% 
                      if(sb.getRole().equals("admin")){
                          ...
                          <li><a class="dropdown-item" href="dashboard.jsp"><span class="glyphicon glyphicon-th-list"></span>&nbsp;&nbsp;&nbsp;&nbsp;PANEL</a></li>
                          ...
                          <li><a class="dropdown-item" href="#"><span class="glyphicon glyphicon-king" style="font-size: 20px;"></span>&nbsp;&nbsp;&nbsp;&nbsp;MI INMUEBLES</a></li>
