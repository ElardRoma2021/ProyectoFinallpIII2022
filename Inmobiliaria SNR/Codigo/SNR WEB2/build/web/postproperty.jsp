            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <form method="POST" action="property_insert_controller" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <select name="ptype" id="ptype" class="ptype" required="">
                                    ...
                                    <option value="Independent House/Villa">Caa independiente</option>
                                    <option value="Independent/Builder Floor">Piso independiente</option>
                                    <option value="Land">Terreno</option>
                                    <option value="Farmhouse">Casa de campo</option>
                                </select>
                            </div>
                        </div>
                        <br><br>
                        <div class="row">
                            <div class="col-sm-2">
                                <label for="srproperty">Estado de Inmueble</label><br>
                            ...
                            <div class="col-sm-2">
                                <label for="psubtype">Sub-tipo</label><br>
                            ...
                            <div class="col-sm-2">
                                <label for="bedroom">Habitaciones</label><br>
                            ...
                            <div class="col-sm-2">
                                <label for="bathroom">Baños</label><br>
                            ...
                            <div class="col-sm-2">
                                ...
                                <select name="cityname" id="cityname" class="cityname" required="">
                                    <option value=" ">---- Select ----</option>
                                    <option value="Mumbai">Tacna</option>
                                    <option value="Pune">Puno</option>
                                    <option value="Nagpur">candarave</option>
                                    <option value="Nashik">tarata</option>
                                    <option value="Thane">Jorge Basadre</option>
                                </select>
                            </div>
                            <div class="col-sm-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <label for="areasq">medicion</label>
                                <select name="areasq" id="areasq" class="cityname" required="">
                                    <option value="null">---- Select ----</option>
                                    <option value="Square Feet">pies</option>
                                    <option value="Square Meter">metro cuadrado</option>
                                    <option value="Square Yard">yardas</option>
                                    <option value="Acre">Acre</option>
                                    <option value="Hectare">Hectarea</option>
                            ...
                            <div class="col-sm-2">
                                <label for="file">Seleccionar imagens</label>
