        ...
        <div class="container">
            <div class="row" style="padding-top: 20px;">
                ...
                <div class="col-sm-6" style="background-color: #cccccc; border: 1px solid black; border-radius: 20px; padding: 40px;">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 style="font-size: 20px; font-weight: bold; display: inline; margin-left: 95px;">Nombre:</h3><h3 style="text-transform: uppercase; font-size: 20px; display: inline; margin-left: 125px;"><%= sb.getName() %></h3><br><br>
                            ...
                            <h3 style="font-size: 20px; font-weight: bold; display: inline; margin-left: 95px;">Telefono:</h3><h3 style=" font-size: 20px; display: inline; margin-left: 105px;"><%= sb.getContact() %></h3><br><br>
                            <h3 style="font-size: 20px; font-weight: bold; display: inline; margin-left: 95px;">Rol:</h3><h3 style="text-transform: uppercase; font-size: 20px; display: inline; margin-left: 135px;"><%= sb.getRole() %></h3><br><br>
                        </div>
                        <%
                            }
                        %>
